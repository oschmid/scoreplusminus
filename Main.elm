...
view model =
    ...
    div [ class "container-fluid" ]
        ...
        , div [ class "row" ]
            [ button [ class "col-xs-3", onClick <| IncUs False ] [ text "+" ]
            , button [ class "col-xs-2", onClick <| IncUs True ] [ text "+ You" ]
            , button [ class "col-xs-2", onClick Reset ] [ text "Reset" ]
            , button [ class "col-xs-2", onClick <| IncThem True ] [ text "- You" ]
            , button [ class "col-xs-3", onClick <| IncThem False ] [ text "-" ]
            ]
        ]